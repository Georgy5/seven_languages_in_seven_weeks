...
assertTrue("The eighth fibonacci number should be 21", (fibonacci(8) == 21))
assertTrue("The ninth fibonacci number should be 34", (fibonacci(9) == 34))
...
assertTrue("The eighth fibonacci number should be 21", fibonacci2(8) == 21)
assertTrue("The ninth fibonacci number should be 34", fibonacci2(9) == 34)
